 ...
 */
const H = globalThis, I = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, et = Symbol(), V = /* @__PURE__ */ new WeakMap();
let at = class {
  constructor(t, e, s) {
...
const st = (r) => new at(typeof r == "string" ? r : r + "", void 0, et), lt = (r, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ct, defineProperty: dt, getOwnPropertyDescriptor: pt, getOwnPropertyNames: $t, getOwnPropertySymbols: ut, getPrototypeOf: _t } = Object, f = globalThis, J = f.trustedTypes, ft = J ? J.emptyScript : "", L = f.reactiveElementPolyfillSupport, b = (r, t) => r, M = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ft : null;
      break;
  ...
  return e;
} }, B = (r, t) => !ct(r, t), K = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: B };
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[b("elementProperties")] = /* @__PURE__ */ new Map(), y[b("finalized")] = /* @__PURE__ */ new Map(), L == null || L({ ReactiveElement: y }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, N = w.trustedTypes, Z = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, it = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, rt = "?" + _, At = `<${rt}>`, g = document, C = () => g.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, mt = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, A = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, nt = /^(?:script|style|textarea|title)$/i, gt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), yt = gt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function ot(r, t) {
...
const vt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, $ = 0;
    for (; $ < h.length && (n.lastIndex = $, p = n.exec(h), p !== null); ) $ = n.lastIndex, n === S ? p[1] === "!--" ? n = F : p[1] !== void 0 ? n = G : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? X : Q) : n === X || n === Q ? n = A : n === F || n === G ? n = S : (n = A, i = void 0);
    const u = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + At : l >= 0 ? (s.push(c), h.slice(0, l) + it + h.slice(l) + _ + u) : h + _ + (l === -2 ? a : u);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(it)) {
          ...
          h.push({ type: 1, index: o, name: T[2], strings: u, ctor: T[1] === "." ? St : T[1] === "?" ? bt : T[1] === "@" ? wt : R }), i.removeAttribute(l);
        ...
        if (nt.test(i.tagName)) {
          ...
          if ($ > 0) {
            ...
            for (let u = 0; u < $; u++) i.append(l[u], C()), m.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[$], C());
          }
        }
...
D == null || D(x, O), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.2.1");
const Ct = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const xt = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: B }, Ot = (r = xt, t, e) => {
...
const Ht = "p strong{--tw-text-opacity: 1;color:rgb(239 68 68 / var(--tw-text-opacity))}";
...
let k = class extends P {
  constructor() {
    super(...arguments), this.version = "1.0.0";
  }
  render() {
    return yt`
